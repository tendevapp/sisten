...
export const CHANGELOG: ChangelogEntry[] = [
  {
    data: '2026-09-16',
    resumo: 'Almoxarifado > Projetos — Matriz de Autonomia de Kits: Legenda no Rodapé da Tabela e Status Preto para Saída da Portaria (`MatrizAutonomiaKits.tsx`, `projetosKitsAutonomia.ts`, `projetosKitsAutonomia.test.ts`, migration `20260916100000_allow_status_5_saida_portaria.sql`, `diretrizes.ts`): 1. A legenda de cores dos status operacionais foi movida do topo da tela para um painel dedicado e estruturado na parte inferior da tabela matricial; 2. Implementado o novo status 5 (Saída Portaria / Preto `#09090B`), representando os tramos de torre que já concluíram o processo fabril e saíram pela portaria da fábrica; 3. O cabeçalho superior foi simplificado, alinhando título e controles de paginação (12 Torres / Todas) com maior clareza visual; 4. Atualizado o modal de edição de células da matriz para permitir a seleção rápida do status 5 (Saída Portaria) e associação de série física; 5. Migração no Supabase atualizando a restrição de verificação (check constraint) de status em `proj_matriz_autonomia_kits` para permitir o status 5; 6. Testes unitários com 100% de aprovação para o novo status e preservação das regras de autonomia.',
  },
  {
    data: '2026-09-16',
