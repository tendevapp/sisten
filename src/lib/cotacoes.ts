...
export function propostaSalvaParaDraft(p: CotacaoProposta): CotacaoPropostaDraft {
  return {
    _key: p.id,
    _salvo: true,
    _extraido_em: p.created_at,
    ...
    valor_frete: p.valor_frete, valor_seguro: p.valor_seguro, valor_desconto: p.valor_desconto,
    valor_outras_despesas: p.valor_outras_despesas, valor_total_produtos: p.valor_total_produtos,
    valor_total_proposta: p.valor_total_proposta,
    ...
    observacoes: p.observacoes, dados_bancarios: p.dados_bancarios,
    itens: (p.itens ?? []).map(it => ({
      ...
      frete_item_rateado: it.frete_item_rateado,
      ...
      prazo_entrega_item_dias: it.prazo_entrega_item_dias, garantia_meses: it.garantia_meses,
      observacoes: it.observacoes, mapa_ordem: it.mapa_ordem,
