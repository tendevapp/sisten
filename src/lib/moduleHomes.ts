...
export const MODULE_HOMES: ModuleHomeDef[] = [
  ...
  },
  {
    ...
    cardDescriptions: {
      ...
      prod_expedicao: 'Programação editável de faturamento, carregamento e expedição dos tramos.',
  ...
  },
  {
    ...
    cardDescriptions: {
      ...
      fin_pep: 'Estrutura analítica do projeto (WBS Element) para apropriação contábil e faturamento.',
    },
  },
  {
    id: 'helpdesk',
