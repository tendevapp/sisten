...
export const CONFIGS_EMAIL_PADRAO: ConfigEnvioEmail[] = [
  {
    ...
    chave: 'cadastro_sap',
    nome: 'Solicitação de Cadastro SAP — Itens',
    modulo: 'SUPRIMENTOS',
    ...
    copia: null,
    copia_oculta: null,
    assunto_padrao: 'Cadastro SAP - Item',
    ativo: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: 'padrao-cadastro-sap-fornecedor',
    chave: 'cadastro_sap_fornecedor',
    nome: 'Solicitação de Cadastro SAP — Fornecedor',
    modulo: 'SUPRIMENTOS',
    descricao: 'Disparado ao enviar uma solicitação de cadastro de FORNECEDOR no SAP (aba Cadastro SAP em Nova Solicitação, tipo "Fornecedor").',
    destinatarios: 'ana.leite@ten.ind.br',
    copia: null,
    copia_oculta: null,
    assunto_padrao: 'Cadastro SAP - Fornecedor',
    ativo: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  ...
  {
    id: 'padrao-coleta-jacobina',
    chave: 'coleta_jacobina',
    nome: 'Lista de Coleta Jacobina (Sem MIGO — Central de Compras)',
    modulo: 'SUPRIMENTOS',
    descricao: 'Disparado ao selecionar itens na aba "Sem MIGO" da Central de Compras e enviar a lista de coleta para a logística buscar o material no fornecedor.',
    destinatarios: 'andre.araujo@ten.ind.br',
    copia: null,
    copia_oculta: null,
    assunto_padrao: 'Coleta Jacobina',
    ativo: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  ...
  {
    id: 'padrao-compra-servico',
    chave: 'compra_servico',
    nome: 'Solicitação de Compra do tipo Serviço',
    modulo: 'SUPRIMENTOS',
    descricao: 'Disparado ao enviar uma solicitação de compra com tipo Serviço (aba Compra em Nova Solicitação).',
    destinatarios: 'jefferson.santana@ten.ind.br',
    copia: null,
    copia_oculta: null,
    assunto_padrao: 'Solicitação de Serviço',
    ativo: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
