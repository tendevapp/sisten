 ...
 * Centraliza a gestão de tabelas mestres, listas suspensas (Setores, Grupos)
 * e gestão de envios de e-mails/Outlook (destinatários, cópias, assuntos padrão).
 */

import React, { useState, useEffect, useMemo } from 'react';
import {
  Database, Users, Boxes, Plus, Search, Edit2, Trash2,
...
import type { Profile, ConfigEnvioEmail, EmailModulo, PrazoTransporte, Transportadora } from '../types';
