      ...
      {(loading || (!error && movs.length > 0)) && (
        <>
          ...
          >
            ...
            {aba === 'geral' && (
              <>
                <select value={centroFiltro} onChange={e => setCentroFiltro(e.target.value)} className={selectClass}>
            ...
            {aba === 'giro' && (
              <select value={coberturaFiltro} onChange={e => setCoberturaFiltro(e.target.value as any)} className={selectClass}>
            ...
            {aba === 'idade' && (
              <select value={faixaIdadeFiltro} onChange={e => setFaixaIdadeFiltro(e.target.value)} className={selectClass}>
            ...
            {aba === 'urgencia' && (
              <select value={classePermFiltro} onChange={e => setClassePermFiltro(e.target.value)} className={selectClass}>
            ...
            {aba === 'minimo' && (
              <select value={recomendacaoFiltro} onChange={e => setRecomendacaoFiltro(e.target.value as any)} className={selectClass}>
            ...
            {filtroAtivo && (
              <button onClick={limparFiltros} className="text-xs font-bold text-rose-500 hover:text-rose-600 dark:text-rose-400 underline ml-auto cursor-pointer">
                Limpar Filtros
              </button>
            )}
          </div>
