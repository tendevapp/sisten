...
const ETAPAS: (Modulo & { etapa: string })[] = [
  ...
  },
  {
    ...
    icon: PlusCircle,
    desc: 'Monte a solicitação com itens, quantidade, criticidade e justificativa. O acompanhamento fica na Central de Solicitações.',
    acesso: { module: 'solicitacoes', action: 'criar' },
  },
  {
    etapa: 'Aprovar',
    label: 'Aprovações',
    path: '/solicitacoes?escopo=acao',
    icon: FileCheck,
