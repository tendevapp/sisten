...
export default function RastreioCompras({ user }: RastreioComprasProps) {
  ...
  const load = useCallback(async (force = false) => {
    ...
    try {
      if (force) {
        // Rebaixa as bases ignorando o gate de versão: "Atualizar" precisa trazer
        ...
        // resolvia.
        try { await localDb.syncFromSupabase(true); } catch (e) { console.warn('Falha ao sincronizar dataset completo:', e); }
