...
const MODULOS: ModuloFormulario[] = [
  ...
  },
  {
    ...
    itensResumo: [
      ...
      'Relatório & Gráficos de Lead Time (SLA 24h)',
  ...
  },
  {
    ...
    icon: Boxes,
    desc: 'Recebimento físico de materiais: ficha cega de volumes na doca e conferência da carga contra o pedido, com foto e sinalização de não conformidade.',
